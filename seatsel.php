...
<!--                <select name="date" onchange="this.form.submit()">
                    <option value="1"<?php// if(isset($_POST['date']) && $_POST['date'] == "1") echo " selected"; ?>><?php //echo date("Y-m-d"); ?></option>
                    <option value="2"<?php //if(isset($_POST['date']) && $_POST['date'] == "2") echo " selected"; ?>><?php //echo date("Y-m-d", strtotime("+1 day")); ?></option>
                    <option value="3"<?php //if(isset($_POST['date']) && $_POST['date'] == "3") echo " selected"; ?>><?php //echo date("Y-m-d", strtotime("+2 day")); ?></option>
                </select>-->
