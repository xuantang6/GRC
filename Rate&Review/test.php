...
<html>
    ...
    <body>       
    	<p class="header">Ratings and Reviews<i id="view-review" class="fas fa-arrow-right arrow"></i></p>      
...
<!--                    <div class="left">-->
                        ...
                        <p class="avgRate"><b><span id="average_rating">4.3</span></b></p>
    			<div>
...
<!--                    </div>-->
<!--                    <div class="right">    class="col-sm-4"-->
                        <div class="right">
    			...
    			<button type="button" name="add_review" id="add_review" class="btn btn-primary" onclick="transition()">Write Review</button>
                    </div>
                        </div>
<!--                    </div>-->
